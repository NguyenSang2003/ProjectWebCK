                ...
                <table class="table table-bordered text-center mb-0">
                    ...
                    <tbody class="align-middle">
                        <tr>
                            ...
                            <td class="align-middle"><button class="btn btn-sm btn-primary">Đang vận chuyển</button>
                            </td>
                            <td>290.000 VNĐ</td>
                        ...
                        <tr>
                            ...
                            <td class="align-middle"><button class="btn btn-sm btn-primary">Đang vận chuyển</td>
                            <td>100.000 VNĐ</td>
                            <td class="align-middle"><button class="btn btn-sm btn-primary"><i
                                        class="fa fa-times"></i></button></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="align-middle"><button class="btn btn-sm btn-primary">Bị Hủy</td>
                            <td>23.000 VNĐ</td>
                            <td class="align-middle"><button class="btn btn-sm btn-primary"><i
                                        class="fa fa-times"></i></button></td>
                        </tr>
